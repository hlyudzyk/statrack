...
public class UserService {
    ...
    public RegistrationResponse registerNewUser(@Valid RegisterRequest request) {
        ...
        String body = """
                ...
                Вас було доєднано до Statrack платформи (Інформаційна дошка циклової комісії програмування та інформаційних технологій) адміністратором.
    ...
    public void seedDatabase() throws IOException {
        ...
        String body = """
            ...
            Ваш акаунт адміністратора на платформі Statrack (Інформаційна дошка циклової комісії програмування та інформаційних технологій) було успішно створено в системі.
            
            Ви можете увійти до платформи за допомогою вказаного нижче пароля:
        ...
        Event event2 = Event.builder()
            .header("До уваги випускників, захист ДП відбуватиметься згідно графіку у 312 аудиторії!")
            .content("Графік та інша інформація опубліковані на сайті коледжу.")
            .createdBy(admin)
            .eventDate(LocalDateTime.now())
            .imageUrl(null)
            .build();
        Event event3 = Event.builder()
            .header("Обхідний лист.")
            .content("Для отримання диплому всім випускникам потрібно оформити обхідний лист. Деталі опубліковано в Classroom.")
            .createdBy(admin)
            .eventDate(LocalDateTime.now())
            .imageUrl(null)
            .build();
        ...
        System.out.println("Created lauch day events...........");
    }
